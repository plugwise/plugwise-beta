...
:warning::no_entry::warning: Do **not** use this custom_component for **USB**, this functionality has been moved to [https://github.com/plugwise/plugwise_usb-beta], see [why](#usb-notes) :warning::no_entry::warning:
