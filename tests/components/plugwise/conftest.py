...
def mock_smile_adam():
    ...
    with patch("homeassistant.components.plugwise.gateway.Smile") as smile_mock:
        ...
        smile_mock.return_value.gw_data["gateway_id"] = "fe799307f1624099878210aa0b9f1475"
...
def mock_smile_anna():
    ...
    with patch("homeassistant.components.plugwise.gateway.Smile") as smile_mock:
        ...
        smile_mock.return_value.gw_data["gateway_id"] = "015ae9ea3f964e668e490fa39da3870b"
        smile_mock.return_value.gw_data["heater_id"] = "1cbf783bb11e4a7c8a6843dee3a86927"
...
def mock_smile_p1():
    ...
    with patch("homeassistant.components.plugwise.gateway.Smile") as smile_mock:
        ...
        smile_mock.return_value.gw_data["gateway_id"] = "e950c7d5e1ee407a858e2a8b5016c8b3"
...
def mock_stretch():
    ...
    with patch("homeassistant.components.plugwise.gateway.Smile") as smile_mock:
        ...
        smile_mock.return_value.gw_data["gateway_id"] = "259882df3c05415b99c2d962534ce820"
        smile_mock.return_value.gw_data["heater_id"] = None
